...
@Component
public class GetResultClient extends AbstractWsClient {
	
	@Autowired
	@Qualifier("getResultTemplate")
    private WebServiceTemplate wsTemplate;
	
	public GetResultResponse submitRequest(GetResultRequest request, final String username, final String password, final String token, final String applicationId){
		GetResultResponse response = (GetResultResponse) wsTemplate.marshalSendAndReceive(request, new WebServiceMessageCallback() {
